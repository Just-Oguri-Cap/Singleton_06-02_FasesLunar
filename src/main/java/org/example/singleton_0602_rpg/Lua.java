...
public class Lua {
    ...
    public void setDiaDoCiclo(int dia) {
        int diaAtual = getDiaDoCiclo();
        int diferenca = dia - diaAtual;
        this.dataSelecionada = this.dataSelecionada.plusDays(diferenca);
    }
    ...
    public void setFaseAtual(FaseLunar faseAtual) {
